...
def scrape(product_number):
	page = requests.get('https://item.rakuten.co.jp/milulu/' + product_number, headers={"user-agent" : "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.69 Safari/537.36"})
	...
	thumbnail = pageSoup.select_one('[src*=thumbnail]')
...
scrape("https://item.rakuten.co.jp/milulu/m221004st0/")